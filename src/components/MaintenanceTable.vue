        ...
        />
          ...
          <div class="q-pa-md">
              <q-table
                ...
                :columns="columns"
                row-key="_id"
                :visible-columns="['Request','RequestedBy', 'ContactNo', 'Barangay','Status','Actions']"
                ...
                <template #body="props">
                  <q-tr :props ="props" >
                      ...
                      <q-td key="Actions" align="center"  >
                          <q-btn flat icon="edit" color="primary" style="font-size: 1em;" @click="GetRequest(props.row._id)"/>
                          <q-btn flat icon="delete" color="negative" style="font-size: 1em; " @click="RemoveRequest(props.row)" />
                      </q-td>
                  </q-tr>
          ...
          <q-card-section>
            <div class="q-pa-xs">
              <div class="q-gutter-md row">
                ...
                <div class="col">
                  <q-input v-model="JOdata.RequestDesc" label="Request Description" />
                </div>
              </div>
              <div class="q-gutter-md row">
                <div class="col">
                ...
                <div class="col">
                  <q-input v-model="JOdata.ContactNo" label="Contact No." inputmode="numeric"
 />
                </div>
              </div>
              <div class="q-gutter-md row">
              ...
              <div class="q-gutter-md row">
                <div class="col">
                  <q-input v-model="JOdata.Remarks" label="Remarks" type="textarea" />
                </div>
              </div>
          ...
          <q-card-actions align="right">
            ...
            <q-btn color="primary" label="Save" v-close-popup @click="SaveNewRequest" />
          </q-card-actions>
        </q-card>
      </q-dialog>
    </div>
      ...
      <q-dialog v-model="forUpdateView" persistent>
        <q-card style="min-width: 1250px">
          ...
          <q-card-section>
            <div class="q-pa-xs">
              ...
              <div class="q-gutter-md row">
                ...
                <div class="col">
                  <q-input v-model="JOdata.ContactNo" label="Contact No." type="number"  />
                </div>
              </div>
              <div class="q-gutter-md row">
                <div class="col">
              ...
              <div class="q-gutter-md row">
                <div class="col" >
                  <q-select v-model="JOdata.Status" :options="StatusSelections" label="Status" style="width: 395px;"   />
                </div>
              </div>
          ...
          <q-card-actions align="right">
            <q-btn color="red" label="Cancel" v-close-popup />
            <q-btn color="primary" label="Update" v-close-popup @click="UpdateData(JOdata)" />
          </q-card-actions>
        </q-card>
      </q-dialog>
    </div>
...
export default {
  data() {
    return {
      ...
      JOdata:{
        ...
        columns: [
                  { name: 'ID', label: 'ID', field: '_id', sortable: true, align: 'left', headerClasses: 'bg-grey-7 text-white', headerStyle: 'font-size: 1.2 em' },
                  { name: 'Request', label: 'Request', field:'RequestDesc', headerClasses: 'bg-grey-7 text-white', align: 'center', headerStyle: 'font-size: 1.2 em'},
                  { name: 'RequestedBy', label: 'Requested By', field: 'RequestedBy', headerClasses: 'bg-grey-7 text-white',  align: 'center', headerStyle: 'font-size: 1.2 em'},
                  { name: 'ContactNo', label: 'Contact No', field: 'ContactNo', headerClasses: 'bg-grey-7 text-white',  align: 'center', headerStyle: 'font-size: 1.2 em'},
                  { name: 'Barangay', label: 'Barangay', field: row=> row.Location.Barangay, headerClasses: 'bg-grey-7 text-white',  align: 'center', headerStyle: 'font-size: 1.2 em'},
                  { name: 'Status', label: 'Status', field: 'Status', headerClasses: 'bg-grey-7 text-white', align: 'center', headerStyle: 'font-size: 1.2 em'},
                  { name: 'Actions', label: 'Actions',headerClasses: 'bg-grey-7 text-white', align: 'center', headerStyle: 'font-size: 1.2 em'},
              ],
  ...
  mounted() {  },
  created() {
    this.clearEmptyValues (this.JOdata)
  },
             ...
             async SaveNewRequest(){
              ...
              //  console.log(`payload => ${payload._id} ------->`, payload )
                ...
                for (const pData in payload){
                  if(payload[pData]===null || payload[pData]=== undefined || payload[pData]===""){
                    payload[pData]="";
                  }
                }
                 const store = useJobOrdersInfoStore();
